...
$lang = array_merge($lang, array(
	...
	'HELP_DL_KLICKS_RESET'		=> 'This option can reset the clicks for this month back to zero.<br />This is usefull if you will controll the clicks after changing the file release.',
	...
	'HELP_DL_TRAFFICS_USERS'			=> 'This option will set a limit to the user traffics for registered users.<br />The user traffic can be enabled or disabled for all registered users or can be set only for members of the user groups which can be selected in the next option.<br />If the user traffic was disabled all affected users can unlimit download and upload files.<br />The affected users also will not get automatic traffic amounts and will not get traffic points while writing a topic or post even this options are enabled, too.',
