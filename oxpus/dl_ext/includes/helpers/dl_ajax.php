...
if ($df_id && $rate_point)
{
	...
	for ($i = 0; $i < $this->config['dl_rate_points']; $i++)
	{
		...
		$rate_img .= ($j <= $new_rating ) ? '<img src="' . $ext_path_images . 'dl_rate_yes.png" alt="' . $this->user->lang['IMG_DL_RATE_YES'] . '" />' : '<img src="' . $ext_path_images . 'dl_rate_no.png" alt="' . $this->user->lang['IMG_DL_RATE_NO'] . '" />';
	}
