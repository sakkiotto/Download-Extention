...
class dl_status extends dl_mod
{
	...
	public static function mini_status_file($parent, $file_id, $ext_path_images, $rss = false)
	{
		...
		{
			$mini_icon_img = ($rss) ? $user->lang['DL_FILE_NEW'] : '<img src="' . $ext_path_images . 'dl_file_new.png" alt="' . $user->lang['IMG_DL_FILE_NEW'] . '" />';
		}
		else if (isset($dl_file_icon['edit'][$parent][$file_id]) && $dl_file_icon['edit'][$parent][$file_id] == true)
		{
			$mini_icon_img = ($rss) ? $user->lang['DL_FILE_EDIT'] : '<img src="' . $ext_path_images . 'dl_file_edit.png" alt="' . $user->lang['IMG_DL_FILE_EDIT'] . '" />';
		}
		else
		{
			$mini_icon_img = '';
	...
	public static function status($df_id, $helper, $ext_path_images)
	{
		...
		{
			return array('status' => '', 'file_name' => '', 'auth_dl' => 0, 'file_detail' => '', 'status_detail' => '<img src="' . $ext_path_images . 'dl_red.png" alt="' . sprintf($user->lang['DL_RED_EXPLAIN_ALT'], $config['dl_posts']) . '" />');
		}
		...
		$status = '';
		$status_detail = '<img src="' . $ext_path_images . 'dl_red.png" alt="' . sprintf($user->lang['DL_RED_EXPLAIN_ALT'], $config['dl_posts']) . '" />';
		$file_name = '';
		$auth_dl = 0;
		...
		if ($user_banned)
		{
			$status_detail = '<img src="' . $ext_path_images . 'dl_red.png" alt="' . $user->lang['DL_BANNED'] . '" />';
		...
		if (!$config['dl_traffic_off'] && (DL_USERS_TRAFFICS == true || FOUNDER_TRAFFICS_OFF == true))
		{
			...
			{
				$status_detail = '<img src="' . $ext_path_images . 'dl_yellow.png" alt="' . $user->lang['DL_YELLOW_EXPLAIN'] . '" />';
				$status = '<a href="' . $helper->route('dl_ext_controller', array('view' => 'detail', 'df_id' => $df_id)) . '">' . $status_detail . '</a>';
				$auth_dl = true;
			}
		...
		{
			$status_detail = '<img src="' . $ext_path_images . 'dl_white.png" alt="' . $user->lang['DL_WHITE_EXPLAIN'] . '" />';
			$status = '<a href="' . $helper->route('dl_ext_controller', array('view' => 'detail', 'df_id' => $df_id)) . '">' . $status_detail . '</a>';
			$auth_dl = true;
		}
		...
		{
			$status_detail = '<img src="' . $ext_path_images . 'dl_green.png" alt="' . $user->lang['DL_GREEN_EXPLAIN'] . '" />';
			$status = '<a href="' . $helper->route('dl_ext_controller', array('view' => 'detail', 'df_id' => $df_id)) . '">' . $status_detail . '</a>';
			$auth_dl = true;
		}
		...
		{
			$status_detail = '<img src="' . $ext_path_images . 'dl_red.png" alt="' . $user->lang['DL_RED_EXPLAIN_PERM'] . '" />';
			$status = '<a href="' . $helper->route('dl_ext_controller', array('view' => 'detail', 'df_id' => $df_id)) . '">' . $status_detail . '</a>';
			$auth_dl = 0;
		}
		...
		{
			$status_detail = '<img src="' . $ext_path_images . 'dl_blue.png" alt="' . $user->lang['DL_BLUE_EXPLAIN_FILE'] . '" />';
			$status = '<a href="' . $helper->route('dl_ext_controller', array('view' => 'detail', 'df_id' => $df_id)) . '">' . $status_detail . '</a>';
		...
		{
			$status_detail = '<img src="' . $ext_path_images . 'dl_blue.png" alt="' . $user->lang['DL_BLUE_EXPLAIN'] . '" />';
			$status = '<a href="' . $helper->route('dl_ext_controller', array('view' => 'detail', 'df_id' => $df_id)) . '">' . $status_detail . '</a>';
		...
		{
			$status_detail = '<img src="' . $ext_path_images . 'dl_grey.png" alt="' . $user->lang['DL_GREY_EXPLAIN'] . '" />';
			$status = '<a href="' . $helper->route('dl_ext_controller', array('view' => 'detail', 'df_id' => $df_id)) . '">' . $status_detail . '</a>';
			$file_name = '<a href="' . $helper->route('dl_ext_controller', array('view' => 'detail', 'df_id' => $df_id)) . '">' . $user->lang['DL_EXTERN'] . '</a>';
			$auth_dl = true;
		}
