...
if ($submit)
{
	...
	if (!$file_extern)
	{
		...
		if (!$file_name)
		{
			trigger_error($this->user->lang['DL_NO_FILENAME_ENTERED'], E_USER_ERROR);
		}
	...
	else
	{
		...
		{
			trigger_error($this->user->lang['DL_NO_EXTERNAL_URL'], E_USER_ERROR);
		}
...
$dl_files_page_title = $this->user->lang['DL_UPLOAD'];
