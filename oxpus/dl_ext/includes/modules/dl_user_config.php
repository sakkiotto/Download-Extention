...
if ($submit)
{
	...
	*/
	...
	$message = sprintf($this->user->lang['DL_USER_CONFIG_SAVED'], '<a href="' . $this->helper->route('dl_ext_controller', array('view' => 'user_config')) . '">', '</a>');
...
$s_user_dl_sort_fix .= '<option value="0">'.$this->user->lang['DL_DEFAULT_SORT'].'</option>';
$s_user_dl_sort_fix .= '<option value="1">'.$this->user->lang['DL_FILE_DESCRIPTION'].'</option>';
$s_user_dl_sort_fix .= '<option value="2">'.$this->user->lang['DL_FILE_NAME'].'</option>';
$s_user_dl_sort_fix .= '<option value="3">'.$this->user->lang['DL_KLICKS'].'</option>';
$s_user_dl_sort_fix .= '<option value="4">'.$this->user->lang['DL_FREE'].'</option>';
$s_user_dl_sort_fix .= '<option value="5">'.$this->user->lang['DL_EXTERN'].'</option>';
$s_user_dl_sort_fix .= '<option value="6">'.$this->user->lang['DL_FILE_SIZE'].'</option>';
$s_user_dl_sort_fix .= '<option value="7">'.$this->user->lang['LAST_UPDATED'].'</option>';
$s_user_dl_sort_fix .= '<option value="8">'.$this->user->lang['DL_RATING'].'</option>';
...
$s_user_dl_sort_dir .= '<option value="0">'.$this->user->lang['ASCENDING'].'</option>';
$s_user_dl_sort_dir .= '<option value="1">'.$this->user->lang['DESCENDING'].'</option>';
