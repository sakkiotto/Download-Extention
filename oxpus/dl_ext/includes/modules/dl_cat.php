...
page_header($this->user->lang['DOWNLOADS']);
...
$this->template->assign_vars(array(
	...
	'DL_MODCP'		=> (isset($total_downloads) && $total_downloads <> 0 && \oxpus\dl_ext\includes\classes\ dl_auth::user_auth($cat, 'auth_mod')) ? sprintf($this->user->lang['DL_MODCP_MOD_AUTH'], '<a href="' . $this->helper->route('dl_ext_controller', array('view' => 'modcp', 'cat_id' => $cat)) . '">', '</a>') : '',
	'T_DL_CAT'		=> (isset($index[$cat]['cat_name']) && $cat) ? $index[$cat]['cat_name'] : $this->user->lang['DL_CAT_NAME'],
