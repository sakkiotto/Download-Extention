...
$lang = array_merge($lang, array(
	...
	'HELP_DOWNLOAD_PATH'			=> 'The relative path under your phpBB root folder.<br />On first installation of this package you will find here the value "files/downloads/".<br />Regard case sensitve names while renaming this folders if you are using Unix/Linux.<br />The slash at the end of the folder name will be important, but do not add a slash at the beginning.<br />This and all included subfolders must be at CHMOD 777, too, to let all functions working faultless.<br />Under this folder you must create one or more subfolders which will contains all physical files.<br />It is recommended to create a subfolder for each logical group of categories.<br />This subfolder must be entered as path in the category with the same syntax as the main folder, but without using the main folder (for more read the help in the category management).<br />You can create more subfolders by using a ftp client or by using the Toolbox (see the link on the top right of this page).',
